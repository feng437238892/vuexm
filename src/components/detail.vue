  ...
  <div class="detail">
    ...
    <div class="content" v-for="(item,index) in arr" :key="index"  >
      <div class="header clear">
        <h2>
          <img :src="arr.author_face" alt="" width="50"/>
        </h2>
        <p>Nicholas</p>
      </div>
      <div class="cont">
        ...
        <div class="time">
          <p>{{arr.time | date}}
            <span>
              <img src="/src/assets/img/zan.png" alt=""/>
            </span>
          </p>
        </div>
        <div class="text-box">
          <!--这里是属于斗气的世界，没有花俏艳丽的魔法，有的，仅仅是繁衍到巅峰的斗气！这里是属于斗气的世界，没有花俏艳丽的魔法，有的，仅仅是繁衍到巅峰的斗气！这里是属于斗气的世界，没有花俏艳丽的魔法，有的，仅仅是繁衍到巅峰的斗气！-->{{arr.content}}
        </div>
      </div>
    </div>
    <div class="foot-btn">
    ...
    created(){
      ...
      setTimeout(()=>{
        this.$http({
          ...
          this.arr=res.data[this.$route.params.id-1]
          console.log(res.data[this.$route.params.id-1],this.$route.params.id-1);
        }).catch((res)=>{})
      },2000)
